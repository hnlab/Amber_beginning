...
echo "Heating..."
$mdrun -i heat.in -p $prmtop -c min.rst7 -ref ../complex_vdw_bonded.rst7 -O -o heat.out -e heat.en -inf heat.info -r heat.rst7 -x heat.nc -l heat.log
...
mkdir complex
cd complex
ln -sf ../../complex_vdw_bonded.parm7 .
ln -sf ../press.rst7 complex_vdw_bonded.rst7
delta_atom=`python /pubhome/yjcheng02/FEP/ikke/tool/diff.py ../../LCH_LPN.pdb`
atom1=${delta_atom%_*}
atom2=${delta_atom##*_}
vdw_bonded="ifsc=1, scmask1=':1@$atom1', scmask2=':2@$atom2',"
for w in 0.00922 0.04794 0.11505 0.20634 0.31608 0.43738 0.56262 0.68392 0.79366 0.88495 0.95206 0.99078; do
      ...
      cd $w
      ln -sf ../complex_vdw_bonded.parm7 ti.parm7
      ln -sf ../complex_vdw_bonded.rst7  ti.rst7
      cp /pubhome/yjcheng02/FEP/ikke/tool/qsub_complex.sh .
      sed -i "s/-N name/-N LCH_LPN_complex/g" qsub_complex.sh
